...
const skinServices = [
  ...
  { name: 'Updo', price: 50 },
  { name: 'Braiding', price: 45 },
  { name: 'Curling', price: 35 },
  { name: 'Straightening', price: 50 },
  { name: 'Perm', price: 70 },
  { name: 'Hair Extensions', price: 100 },
  { name: 'Balayage Styling', price: 80 },
  { name: 'Keratin Treatment', price: 90 },
  { name: 'Vintage Styling', price: 55 },
  { name: 'Manicure', price: 25 },
  { name: 'Pedicure', price: 30 },
  { name: 'Gel Manicure', price: 35 },
  { name: 'Acrylic Nails', price: 40 },
  { name: 'Dip Powder Nails', price: 38 },
  { name: 'Nail Art', price: 20 },
  { name: 'French Manicure', price: 30 },
  { name: 'Spa Pedicure', price: 45 },
  { name: 'Nail Repair', price: 15 },
  { name: 'Paraffin Treatment', price: 20 },
  { name: 'Shellac Removal', price: 10 },
  { name: 'Facial', price: 60 },
  { name: 'HydraFacial', price: 80 },
  { name: 'Chemical Peel', price: 100 },
  { name: 'Microdermabrasion', price: 85 },
  { name: 'LED Light Therapy', price: 70 },
  { name: 'Microneedling', price: 90 },
  { name: 'Acne Treatment', price: 75 },
  { name: 'Anti-Aging Facial', price: 90 },
  { name: 'Oxygen Facial', price: 85 },
  { name: 'Dermaplaning', price: 65 },
  { name: 'Skin Brightening', price: 70 },
  { name: 'Custom Tattoo', price: 120 },
  { name: 'Cover-Up Tattoo', price: 100 },
  { name: 'Touch-Up', price: 50 },
  { name: 'Flash Tattoo', price: 40 },
  { name: 'Portrait Tattoo', price: 150 },
  { name: 'Traditional Tattoo', price: 90 },
  { name: 'Watercolor Tattoo', price: 110 },
  { name: 'Blackwork Tattoo', price: 95 },
  { name: 'Script Tattoo', price: 60 },
  { name: 'Micro Tattoo', price: 50 },
  { name: 'Temporary Tattoo', price: 30 },
];

const staff = [
  { name: 'Clara Evans', role: 'Esthetician', image: 'https://images.unsplash.com/photo-1517365830460-955ce3f5b1f7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
  { name: 'Maya Brooks', role: 'Skincare Specialist', image: 'https://images.unsplash.com/photo-1524504388940-b6f&auto=format&fit=crop&w=500&q=60' },
  { name: 'Elena Ortiz', role: 'Facial Expert', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60' },
];
...
const SkinApp = () => {
  ...
  // Price calculation
  const selectedServicePrice = skinServices.find(service => service.name === formData.selectedService)?.price || 0;
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { customerName, phoneNumber, email, selectedService, selectedStaff, date, time, skinTool, imageFile } = formData;
    ...
    formDataToSend.append('skinTool', skinTool);
    if (imageFile) {
              ...
              >
                <form onSubmit={handleSubmit}>
                  <VStack spacing={6} align="stretch">
                    ...
                    <FormControl isRequired>
                      <FormLabel color="purple.600" fontFamily="'Montserrat', sans-serif">Service</FormLabel>
                      <Select
                    ...
                    <FormControl isRequired>
                      <FormLabel color="purple.600" fontFamily="'Montserrat', sans-serif">Skincare Specialist</FormLabel>
                      <Select
                    ...
                    <FormControl isRequired>
                      <FormLabel color="purple.600" fontFamily="'Montserrat', sans-serif">Skin Tool</FormLabel>
                      <Select
                        value={formData.skinTool}
                        onChange={handleFormChange('skinTool')}
                        placeholder="Select a skin tool"
                        bg="gray.100"
                        borderColor={currentTheme.secondaryColor}
                        _focus={{ borderColor: currentTheme.primaryColor }}
                      >
              ...
              >
                <VStack spacing={6}>
                  <Image
                    ...
                    alt="Skincare Appointment Confirmation"
                    boxSize="150px"
                    borderRadius="full"
                    objectFit="cover"
                    border="3px solid"
                  ...
                  >
                    <VStack spacing={4}>
                      <Image
                        ...
                        border="3px solid"
                        borderColor={currentTheme.primaryColor}
                        fallbackSrc="https://picsum.photos/120"
                      />
